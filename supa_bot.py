...
huggingFacellm = HuggingFaceHub(
    repo_id="google/flan-t5-xxl",
    huggingfacehub_api_token=huggingFaceApikey,
)
...
crc = ConversationalRetrievalChain.from_llm(llm=openAillm, retriever=get_vector_store_retriever(), verbose=True,)

api_chain = APIChain.from_llm_and_api_docs(llm=openAillm, api_docs='' ,verbose=True,)
